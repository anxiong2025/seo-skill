...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/13_模块-80+_检查项-blue.svg" alt="80+ Checks">
</p>
...
<p align="center">
  SEO 决定了用户能不能找到你。<br>
  关键词研究、竞品分析、技术 SEO、结构化数据、OG 社交卡片、链接建设、本地 SEO、AI 爬虫优化<br>
  ——13 大类 80+ 项检查，覆盖从 Google 排名到 ChatGPT 引用的每一个细节。<br>
...
| **链接建设** | 内链架构、主题集群、锚文本优化、孤立页面检测、外链健康检查 | 🟡 |
| **本地 SEO** | NAP 一致性、LocalBusiness JSON-LD、Google Maps 嵌入、本地关键词 | 🟡 |
...
```
seo-skill/
├── SKILL.md                              # SEO 审计操作系统（13 模块 80+ 检查项）
├── README.md                             # 你正在看的这个
├── LICENSE                               # MIT
├── references/
...
问题是：SEO 的知识太零散了。关键词研究、竞品分析、meta 标签、结构化数据、Core Web Vitals、AI 爬虫适配……每个都有讲究，每个都容易遗漏。
